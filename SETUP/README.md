...
1.  Initialize the basic project infrastructure.
    ...
    ```bash
    just init cdp-seattle-staging-dbengvtn
    ```
...
1.  Attach the Google Service Account JSON as GitHub Repository Secret.
    ...
    1. Create a [new secret](https://github.com/CouncilDataProject/seattle-staging/settings/secrets/actions/new)

    -   Set the name to: **GOOGLE_CREDENTIALS**
    -   Set the value to: the contents of the file `.keys/cdp-seattle-staging-dbengvtn.json`
    -   Click "Add secret"

    2. Create a [new secret](https://github.com/CouncilDataProject/seattle-staging/settings/secrets/actions/new)
...
1.  Initial Firebase Storage.
    ...
    [Firestore Storage Page](https://console.firebase.google.com/u/0/project/cdp-seattle-staging-dbengvtn/storage)
